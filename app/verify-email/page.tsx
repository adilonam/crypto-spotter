...
setVerified(false)
    ...
    const switchStatus = () => {
        ...
        const bad = (<div className="font-normal text-gray-700 dark:text-gray-400">
            Email verification failed.
            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 inline-block ml-2 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    return (
        <div className='pt-2'>
            <div className=" mx-auto block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                ...
                <p className="mb-2 text-2xl  text-gray-900 dark:text-white">Email Verification</p>
